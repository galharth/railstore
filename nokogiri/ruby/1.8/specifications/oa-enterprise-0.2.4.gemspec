...
Gem::Specification.new do |s|
  ...
  s.files = ["spec/fixtures/cas_failure.xml", "spec/fixtures/cas_success.xml", "spec/omniauth/strategies/cas_spec.rb", "spec/spec_helper.rb"]
  s.homepage = %q{http://github.com/intridea/omniauth}
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.6.2}
  s.summary = %q{Enterprise strategies for OmniAuth.}
  s.test_files = ["spec/fixtures/cas_failure.xml", "spec/fixtures/cas_success.xml", "spec/omniauth/strategies/cas_spec.rb", "spec/spec_helper.rb"]
